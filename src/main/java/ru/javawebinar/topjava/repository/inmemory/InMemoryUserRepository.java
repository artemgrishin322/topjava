...
public class InMemoryUserRepository implements UserRepository {
...

    {
        ...
        repository.put(counter.incrementAndGet(), new User(id1, "Admin", "admin.mail@gmail.com", "adminPassword08", Role.ADMIN, Role.USER));
        int id2 = counter.incrementAndGet();
        repository.put(id2, new User(id2, "Vasiliy", "vasiliy.smbd@yandex.ru", "vas3008ghp", 2500,
